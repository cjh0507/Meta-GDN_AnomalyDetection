...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num_epochs', type=int, help='epoch number', default=1000)
    argparser.add_argument('--num_epochs_GDN', type=int, help='epoch number for GDN', default=1000)
